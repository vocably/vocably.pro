...
resource "aws_api_gateway_deployment" "deployment" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      md5(file("${path.module}/api-public-static-files.tf")),
      ...
      aws_lambda_function.chat_with_card.last_modified,
    ]))
  }
  depends_on = [
    ...
    aws_api_gateway_integration.get_public_static_file,
    aws_api_gateway_integration_response.get_public_static_file_200,
    aws_api_gateway_integration_response.get_public_static_file_404,
