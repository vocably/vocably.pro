...
const translations: BaseTranslations = {
  ...
  dashboard: {
    ...
    empty: {
      ...
      headOverToGenerator:
        'O usa el generador de tarjetas para crear tu primera colección.',
  ...
  study: {
    ...
    motivationalQuotes: {
      '0': 'La perseverancia no es una carrera larga; son muchas carreras cortas, una tras otra.',
      '1': 'Un río atraviesa la roca no por su fuerza, sino por su constancia.',
      '2': 'La constancia garantiza que los resultados sean inevitables.',
      '3': 'La paciencia y la perseverancia son las llaves de la grandeza.',
      '4': 'Cada paso adelante, por pequeño que sea, es un avance.',
      '5': 'La constancia convierte los sueños en realidad; cada esfuerzo es una semilla del éxito.',
      '6': 'Cada vez que avanzas, reescribes tu historia hacia el éxito.',
      '7': 'Sigue creyendo en ti: tu constancia es tu superpoder.',
      '8': 'El éxito se construye con los ladrillos de la perseverancia, uno a uno.',
      '9': 'El universo se mueve por quienes nunca dejan de avanzar.',
      '10': 'La energía que pones hoy alimenta el éxito del mañana.',
      '11': 'La perseverancia transforma lo imposible en inevitable.',
      '12': 'Cada palabra que aprendes te acerca a comprender una nueva cultura.',
      '13': 'Aprender un idioma es un maratón, no un sprint. ¡Vas bien!',
      '14': 'La constancia es el ingrediente secreto para llegar a la fluidez. ¡Sigue así!',
      '15': 'La práctica es la clave del éxito en el aprendizaje de idiomas. ¡Usted está en el camino correcto!',
      '16': 'Un segundo idioma no es solo una habilidad, es un regalo que sigue dando.',
      '17': 'Cada vez que estudias, reprogramas tu cerebro hacia el éxito.',
      '18': 'Quien aprende un idioma es un explorador del mundo de incógnito.',
      '19': 'Cada error que cometes al aprender demuestra que estás creciendo.',
      '20': 'Los idiomas son las llaves del mundo; cada palabra que dominas abre nuevas puertas.',
      '21': 'La fluidez no es velocidad; es aparecer y practicar cada día.',
      '22': 'Un nuevo idioma no solo te enseña palabras; te enseña nuevas formas de pensar.',
      '23': 'Pequeños esfuerzos constantes traen grandes resultados que cambian la vida al aprender idiomas.',
      '24': 'Nunca te arrepentirás del tiempo que dediques a aprender un idioma: es una inversión en ti.',
      '25': 'Cada idioma que aprendes añade una nueva dimensión a tu identidad.',
      '26': 'Aunque hoy parezca difícil, mañana tu esfuerzo te hará sonreír.',
      '27': 'El camino hacia la fluidez es una historia que merece ser contada: sigue escribiéndola.',
    },
  },
  exportDeck: {
  ...
  requestFeedback: {
    question:
      '¿Te gusta Vocably? Valorarlo en {{storeName}} te llevará menos de un minuto y ayudará a este proyecto.',
    rateButton: 'Valorar Vocably en {{storeName}}',
    later: 'Pregúntame más tarde',
