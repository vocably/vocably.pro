...
const translations: BaseTranslations = {
  ...
  study: {
    ...
    motivationalQuotes: {
      ...
      '6': 'Her ileri attığın adım, hikâyeni başarıyla yeniden yazar.',
      '7': 'Kendine inanmaya devam et — kararlılığın senin süper gücün.',
      ...
      '10': 'Bugün ortaya koyduğun enerji, yarının başarısına yakıt olur.',
      '11': 'Kararlılık imkânsızı kaçınılmaza dönüştürür.',
      '12': 'Öğrendiğin her kelime, seni yeni bir kültürü anlamaya bir adım daha yaklaştırır.',
      '13': 'Dil öğrenmek bir maraton, bir sprint değildir. Çok iyisin!',
      '14': 'Kararlılık, akıcı olmanın gizli içeriğidir. Devam et!',
      '15': 'Pratik mükemmel yapmaz — ilerleme yaratır ve önemli olan budur.',
      '16': 'İkinci bir dil sadece bir yetenek değil, vermeye devam eden bir hediyedir.',
      '17': 'Her çalışmanda, beynini başarı için yeniden programlıyorsun.',
      '18': 'Bir dil öğrenicisi, kılık değiştirmiş bir dünya kâşifidir.',
      '19': 'Öğrenirken yaptığın her hata, büyüdüğünün kanıtıdır.',
      '20': 'Diller dünyanın anahtarlarıdır; öğrendiğin her kelime yeni kapılar açar.',
      '21': 'Akıcılık hız değildir; her gün ortaya çıkmak ve pratik yapmaktır.',
      '22': 'Yeni bir dil sana yalnızca kelimeler değil, yeni düşünme biçimleri de öğretir.',
      '23': 'Küçük ama sürekli çabalar, dil öğreniminde hayatı değiştiren büyük sonuçlara yol açar.',
      '24': 'Bir dil öğrenmek için ayırdığın zamana asla pişman olmayacaksın — bu kendine yaptığın bir yatırımdır.',
      '25': 'Öğrendiğin her dil, kimliğine yeni bir boyut katar.',
      '26': 'Bugün zor gelse bile, yarın çabaların yüzünü güldürecek.',
      '27': 'Akıcılığa giden yol, anlatılmaya değer bir hikâyedir — yazmaya devam et.',
    },
  },
  exportDeck: {
