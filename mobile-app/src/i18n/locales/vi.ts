...
const translations: BaseTranslations = {
  ...
  study: {
    ...
    motivationalQuotes: {
      '0': 'Kiên trì không phải là một cuộc đua dài; đó là nhiều cuộc đua ngắn nối tiếp nhau.',
      '1': 'Dòng sông xuyên qua đá không phải bằng sức mạnh, mà bằng sự bền bỉ.',
      '2': 'Sự bền bỉ đảm bảo kết quả là điều tất yếu.',
      '3': 'Kiên nhẫn và bền bỉ là chìa khóa để mở cánh cửa của sự vĩ đại.',
      '4': 'Mỗi bước tiến, dù nhỏ đến đâu, đều là sự tiến bộ.',
      '5': 'Sự bền bỉ biến giấc mơ thành hiện thực; mỗi nỗ lực là một hạt giống của thành công.',
      '6': 'Mỗi lần bạn tiến lên, bạn viết lại câu chuyện của mình theo hướng thành công.',
      '7': 'Hãy tiếp tục tin vào chính mình — sự bền bỉ chính là siêu năng lực của bạn.',
      '8': 'Thành công được xây từ những viên gạch bền bỉ, đặt từng viên một.',
      '9': 'Vũ trụ chuyển động vì những người không bao giờ ngừng tiến về phía trước.',
      '10': 'Năng lượng bạn bỏ ra hôm nay là nhiên liệu cho thành công ngày mai.',
      '11': 'Sự bền bỉ biến điều không thể thành điều tất yếu.',
      ...
      '19': 'Mỗi sai lầm bạn mắc phải khi học là bằng chứng cho thấy bạn đang trưởng thành.',
      '20': 'Ngôn ngữ là chìa khóa của thế giới; mỗi từ bạn làm chủ mở ra những cánh cửa mới.',
      '21': 'Sự thông thạo không phải là tốc độ; đó là việc xuất hiện và luyện tập mỗi ngày.',
      '22': 'Một ngôn ngữ mới không chỉ dạy bạn từ vựng; nó dạy bạn những cách suy nghĩ mới.',
      '23': 'Những nỗ lực nhỏ nhưng đều đặn dẫn đến những kết quả to lớn thay đổi cuộc đời trong việc học ngôn ngữ.',
      '24': 'Bạn sẽ không bao giờ tiếc thời gian dành để học ngôn ngữ — đó là khoản đầu tư cho chính bạn.',
      '25': 'Mỗi ngôn ngữ bạn học thêm vào một chiều kích mới cho danh tính của bạn.',
      '26': 'Dù hôm nay có khó khăn, ngày mai những nỗ lực của bạn sẽ khiến bạn mỉm cười.',
      '27': 'Hành trình đến với sự thông thạo là một câu chuyện đáng kể — hãy tiếp tục viết nó.',
    },
  },
  exportDeck: {
