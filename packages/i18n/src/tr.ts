...
export const tr: Record<LanguageTranslationOption, string> = {
  ...
  for_bg: 'Bulgarca',
  for_ca: 'Katalanca',
  for_zh: 'Çince (Basitleştirilmiş)',
  'for_zh-TW': 'Çince (Geleneksel)',
  for_co: 'Korsikaca',
  for_hr: 'Hırvatça',
  for_cs: 'Çekçe',
  for_da: 'Danca',
  for_nl: 'Felemenkçe',
  for_en: 'İngilizce (ABD)',
  'for_en-GB': 'İngilizce (Britanya)',
  for_eo: 'Esperanto',
  for_et: 'Estonca',
  for_fi: 'Fince',
  for_fr: 'Fransızca',
  ...
  for_fa: 'Farsça',
  for_pl: 'Lehçe',
  for_pt: 'Portekizce (Brezilya)',
  'for_pt-PT': 'Portekizce (Avrupa)',
  for_pa: 'Pencapça',
  for_ro: 'Romence',
  for_ru: 'Rusça',
  for_sm: 'Samoaca',
  for_gd: 'İskoç Gaelcesi',
  for_sr: 'Sırpça',
  for_st: 'Sesotho',
  for_sn: 'Shona',
  for_sd: 'Sindhi',
